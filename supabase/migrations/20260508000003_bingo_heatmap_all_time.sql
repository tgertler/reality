-- Rewrites fn_feed_bingo_field_heatmap_block to use all-time data instead of a 7-day window.
...
BEGIN
  RETURN (
    ...
    field_presence AS (
      ...
      JOIN public.bingo_session_items bsi ON bsi.bingo_session_id = bs.id
